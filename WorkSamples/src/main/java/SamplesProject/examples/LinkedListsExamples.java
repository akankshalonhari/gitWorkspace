...
public class LinkedListsExamples {
	...
	LinkedListsExamples(){
		...
		LinkedLists alphaList = new LinkedLists();
		alphaList.push(1);
		alphaList.push(2);
		alphaList.push(3);
		alphaList.push(5);
		...
		LinkedLists loopList = new LinkedLists();
		loopList.push(1);
		loopList.push(2);
		loopList.push(3);
		loopList.push(0);
...
public static Node sumLists(LinkedLists list1 , LinkedLists list2){
	int l1 = list1.length();
	int l2 = list2.length();
	if(l1 > l2){
		int pad = l1-l2;
...
public static boolean isPalindrome(LinkedLists list){
	int len = list.length();
	int mid = 0;
	if(len%2 ==0)
		mid = len/2 - 1;
...
public static boolean isPalinMeth2(LinkedLists list){return true;}

/* Find a point where 2 lists intersect */
public static Node intersectionPt(LinkedLists l1, LinkedLists l2){
	Node inter = null;
	Node head1 = l1.head;
	Node head2 = l2.head;
	int diff = 0;
...
/* Finds if LinkedLists is circular */
public static boolean isLoop(LinkedLists list){
	Node head = list.head;
	Node p1 = head;
	Node p2 = head;
